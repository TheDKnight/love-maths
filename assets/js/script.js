...
/**
 * Checks the answer against the first element in the returned calcuteCorrectAnswer array
 * 
 */
...
if (operator === "+" ){
    ...
    return [operand1 * operand2, "multiply"];
        ...
        alert(`unimpeneted operator  ${operator} `);
        throw `Uunimpeneted operator  ${operator}. Aborting!`;
    }
